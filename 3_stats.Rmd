...
> **For those who are more experienced in R** - you might be aware that there are multiple ways to achieve the function, for loops are just a straightforward approach that do not require many additional packages however other functions and packages (like plyr and tidyr) can be used to acheive the same result. 
...
Below though we show a summary of all the t-test analysis done across all assays.
