...
So a substantial number of what seem like significant changes. However when performing multiple t-tests and assessing significance then multiple testing correction should be performed to avoid false positive results. 
